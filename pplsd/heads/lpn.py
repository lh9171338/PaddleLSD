...
class LPN(nn.Layer):
    ...
    def _sample_lines(
        ...
        Args:
            ...
            gt_lines (list[Tensor]): The list of ground truth lines, shape: [num_lines, 2, 2]
            gt_samples (list[Tensor]): The list of ground truth samples, shape: [N, 2, 2]
            gt_labels (list[Tensor]): The list of ground truth labels, shape: [N]
